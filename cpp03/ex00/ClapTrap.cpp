...
ClapTrap::ClapTrap(const std::string& n)
    : name(n), hitPoints(10), energyPoints(10), attackDamage(0) //ask about this is it unecessary
{
...
ClapTrap::ClapTrap(const ClapTrap& other)
    : name(other.name), hitPoints(other.hitPoints),
      energyPoints(other.energyPoints), attackDamage(other.attackDamage) // ask about this , can we just use them inside or just do *this = other
{
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    std::cout << "ClapTrap " << name << " takes " << amount << " points of damage, HP is now " << hitPoints << ".\n";
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    energyPoints -= 1;
    hitPoints += amount;
    std::cout << "ClapTrap " << name << " repairs itself for " << amount << " points, HP is now " << hitPoints << ".\n";
}
